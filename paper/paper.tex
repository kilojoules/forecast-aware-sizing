...
from $\alpha = 0$ to CVaR$_{0.85}$ the optimal capacity halves to
quarters in every regime (Table~\ref{tab:spdecomp}, last columns), because
larger batteries carry more revenue dispersion across periods.
