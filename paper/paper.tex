...
The conclusion is dated, deliberately: the March-2025 Nordic balancing reforms (PICASSO accession October 2024, 15-minute imbalance settlement March 2025) lifted DK1 mean up-regulation spreads from $92$ to $123$ EUR/MWh and left only $27\%$ of imbalance prices within $\pm 10$ EUR/MWh of DA \citep{bluepower2025}. Those spreads sit \emph{at or above} the saturated $\lambda^* \approx 50$ of wind-heavy plants: by this paper's own map, DK1 hybrid plants with wind/battery ratios $\gtrsim 5$ have crossed into the regime where forecast quality drives the capacity decision. Replicating the $\lambda_{\mathrm{eff}}$ computation on post-reform settlement data is the immediate next test the diagnostic prescribes.

\begin{figure}[t]
\centering
\includegraphics[width=0.95\textwidth]{fig_paper_real_imbalance.png}
\caption{\label{fig:realimbalance}Real-settlement anchor for the break-point study. Left: effective penalty $\lambda_{\mathrm{eff}}$ of actual DK1 imbalance settlement (eSett) per study year, against the measured break-point band and the post-March-2025 mean up-regulation spread; no argmax divergence occurs under real settlement in any year. Right: break-point $\lambda^*$ (first argmax divergence) vs.\ wind/battery ratio for three DK1 years; $\lambda^*$ saturates near $50$ EUR/MWh rather than falling inversely. Real 2021--2023 settlement (grey band) sat below every measured break-point; post-2025 spreads (red band) sit at or above the saturation level.}
\end{figure}
